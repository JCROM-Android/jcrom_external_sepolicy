...
POLICYVERS ?= 26
POLICY_REVISION := $(shell git --git-dir=$(LOCAL_PATH)/.git describe)
MLS_SENS=1
MLS_CATS=1024
...
$(LOCAL_BUILT_MODULE) : $(ALL_POLICY_FILES) $(LOCAL_PATH)/tools/genserev.py
	@mkdir -p $(dir $@)
	$(LOCAL_PATH)/genserev.py -r $(POLICY_REVISION) -o $@ $(ALL_POLICY_FILES)
