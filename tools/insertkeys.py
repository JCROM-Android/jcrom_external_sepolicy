        ...
        for tag in self.sections():
            ...
            for option in options:
                ...
                option != ParseConfig.OPTION_WILDCARD_TAG:
                    logging.info("Skipping " + tag + " : " + option + " because release build is set to " + str(target_build_variant))
                    continue
                ...
                # in the pem file. GenerateKeys supports
...
class ReplaceTags(handler.ContentHandler):
    ...
    TAGS_WITH_CHILDREN = [ POLICY_TAG, DEFAULT_TAG, SIGNER_TAG ]
    ...
    def startElement(self, name, attrs):
        ...
        if name in ReplaceTags.TAGS_WITH_CHILDREN:
            self._out.write('>')
        else:
            self._out.write(' />')
