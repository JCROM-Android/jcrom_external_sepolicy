 ...
 *
 * @note
 * 	The error handling this code does not free anything as all
 * 	error's are fatal and the program just exits. However,
 * 	runtime allocations should be freed based on normal logic, ie
 * 	when updates to the hast table occur do to a replace.
 */
